...
# BSC/EVM Arbitrage Bot (Version Capybara)

A somewhat-profitable, experimental and in development arbitrage bot for BSC, ETH, AVAX, MATIC, FTM, CRO, Harmony, Milkomeda, Moonforce, etc. Alpha release. Use at your own risk. Designed to monitor EVM mempools and seek potentially profitable arbitrage transactions.
